            ...
            {!loading() && (noSession() || tier() === "FREE") && (
                <div class="workspace-placeholder p-2">
                    ...
                    <p class="mt-4" style={{ "line-height": "1.7rem" }}>
                        With the <span class="bg-yellow-foreground text-black px-2 rounded-sm inline-block">Plus</span> plan.
                    </p>
                    <p class="mt-4 text-sm">
                        Log in to access and purchase the one-time Plus plan to access these features.
                    </p>
                    <div class="mt-6">
                        <button type="button" class="rounded bg-terminal hover:bg-terminal-700 p-2 w-full text-white" onClick={openPlusDialog}>Know More</button>
                    </div>
                </div>
            )}
